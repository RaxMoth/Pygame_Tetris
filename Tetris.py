...
shape_colors = [(232, 179, 32), (165, 217, 87), (29, 207, 159),
                (80, 199, 217), (255, 165, 0), (122, 129, 230), (128, 0, 128)]
...
def valid_space(shape, grid):
    accepted_pos = [[(j, i) for j in range(10) if grid[i][j]
                     == (255, 255, 255)] for i in range(20)]
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    pygame.draw.rect(surface, (100, 100, 100), (top_left_x,
...
def main(win):  # *
    ...
    while run:
        ...
        if check_lost(locked_positions):
            draw_text_middle(win, "YOU LOST!", 80, (242, 12, 31))
            pygame.display.update()
...
def main_menu(win):
    ...
    while run:
        ...
        draw_text_middle(win, 'Start', 60, (52, 227, 87))
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
